...
with geo_left:
    b_val = st.number_input("Overall member thickness, h", value=3.0, min_value=0.0001, format="%.4f")
    h_val = st.number_input("Member width, b", value=0.25, min_value=0.0001, format="%.4f")
